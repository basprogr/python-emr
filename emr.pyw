...
def main():   
    ...
    vitalSignInput = tk.Text(vitalSignFieldset, width=40, height=10, font=(ff, fs))
    ...
    pindahan_INPUT = modEntry(row1, width='5', font=(ff, fs), placeholder='Fr') 
    ...
    nadi_INPUT = modEntry(row6, width='5', font=(ff, fs), placeholder='Pul') 
    nadi_INPUT.pack(side=tk.LEFT, padx='1')  
    suhu_INPUT = modEntry(row6, width='5', font=(ff, fs), placeholder='Temp') 
    suhu_INPUT.pack(side=tk.LEFT, padx='1')  
    rr_INPUT = modEntry(row6, width='5', font=(ff, fs), placeholder='Resp') 
    rr_INPUT.pack(side=tk.LEFT, padx='1')  
    spo2_INPUT = modEntry(row6, width='5', font=(ff, fs), placeholder='Sat') 
